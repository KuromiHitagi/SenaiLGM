            ...
            <div class="card">
                ...
                <div class="cardCont">
                    ...
                    <div class="action">
                        ...
                        <button onclick="addCarrinho('${produtos[i].nome}', ${produtos[i].preco.toFixed(2)})">
                            <img src="../src/Images/marketCar-icon.png" alt="marketCar" width="45px" height="42px"/>
                        </button>
